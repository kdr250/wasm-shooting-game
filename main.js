...
Module['FS_createPath']("/resources", "texture", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/font/Roboto-Bold.ttf", "start": 0, "end": 128676}, {"filename": "/resources/shader/Sprite.frag", "start": 128676, "end": 128849}, {"filename": "/resources/shader/Sprite.vert", "start": 128849, "end": 129493}, {"filename": "/resources/shader/SpriteV3.frag", "start": 129493, "end": 129643}, {"filename": "/resources/shader/SpriteV3.vert", "start": 129643, "end": 130325}, {"filename": "/resources/texture/example.png", "start": 130325, "end": 130885}], "remote_package_size": 130885});

  })();

// end include: /tmp/tmp4au984s4.js
// include: /tmp/tmp_y3ov_dh.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp_y3ov_dh.js
// include: /tmp/tmpeiiqsdco.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpeiiqsdco.js
