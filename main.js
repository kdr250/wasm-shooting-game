...
Module['FS_createPath']("/resources", "texture", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/shader/Sprite.frag", "start": 0, "end": 173}, {"filename": "/resources/shader/Sprite.vert", "start": 173, "end": 817}, {"filename": "/resources/shader/SpriteV3.frag", "start": 817, "end": 967}, {"filename": "/resources/shader/SpriteV3.vert", "start": 967, "end": 1649}, {"filename": "/resources/texture/example.png", "start": 1649, "end": 2209}], "remote_package_size": 2209});

  })();

// end include: /tmp/tmptlx5jzh3.js
// include: /tmp/tmpcqyht_u6.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpcqyht_u6.js
// include: /tmp/tmpwgvryivd.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpwgvryivd.js
