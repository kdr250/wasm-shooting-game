...
Module['FS_createPath']("/resources", "texture", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/font/Roboto-Bold.ttf", "start": 0, "end": 128676}, {"filename": "/resources/shader/Bullet.frag", "start": 128676, "end": 129031}, {"filename": "/resources/shader/Bullet.vert", "start": 129031, "end": 129682}, {"filename": "/resources/shader/BulletV3.frag", "start": 129682, "end": 130011}, {"filename": "/resources/shader/BulletV3.vert", "start": 130011, "end": 130696}, {"filename": "/resources/shader/Sprite.frag", "start": 130696, "end": 130869}, {"filename": "/resources/shader/Sprite.vert", "start": 130869, "end": 131513}, {"filename": "/resources/shader/SpriteV3.frag", "start": 131513, "end": 131663}, {"filename": "/resources/shader/SpriteV3.vert", "start": 131663, "end": 132345}, {"filename": "/resources/texture/example.png", "start": 132345, "end": 132905}], "remote_package_size": 132905});

  })();

// end include: /tmp/tmpsxt7iez3.js
// include: /tmp/tmp45ai5swj.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp45ai5swj.js
// include: /tmp/tmpodeq55fa.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpodeq55fa.js
...
var ASM_CONSTS = {
 ...
 378714: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 378797: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 378866: () => { return window.innerWidth; },  
 378896: () => { return window.innerHeight; }
};
